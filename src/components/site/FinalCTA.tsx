...
export function FinalCTA() {
  return (
    ...
    >
      <div className="absolute inset-0 z-0" style={{ overflow: "hidden" }}><DotGrid color="13, 13, 13" /></div>
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <div style={{
              ...
              <ScrambledText
                ...
                style={{ margin: 0 }}
              />
              <strong style={{ fontWeight: 900, color: "var(--ink)", display: "block", marginTop: "4px" }}>
