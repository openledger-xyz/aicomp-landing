    ...
    <section className="relative overflow-hidden" style={{ borderBottom: "1px solid var(--ink)" }}>
      <div className="container-x grid lg:grid-cols-2 gap-12 lg:gap-24 pt-10 lg:pt-4 pb-16 lg:pb-24 items-center">
        ...
        <div className="reveal min-w-0">
          ...
          >
            <span ref={refLine1} style={{ display: "block", lineHeight: 1.1 }}>
              Real-time
            </span>
            <span ref={refLine2} style={{ display: "block", lineHeight: 1.1 }}>
              Infra for
            </span>
          ...
          <p
            className="max-w-xl"
            style={{ color: "var(--ink-soft)", fontSize: 16, lineHeight: 1.65, marginTop: 28 }}
          >
            Dopamint powers emotionally intelligent companion products built for live voice,
            persistent identity, multimodal generation, long-session engagement, and physical AI
            embodiment.
          </p>
          <p
            className="max-w-xl"
        ...
        <div className="reveal relative w-full flex items-center justify-center pt-16 pb-12 sm:px-4 md:pt-32 md:pb-20 lg:px-0 lg:pt-0 lg:pb-0 min-h-[400px] lg:min-h-[600px]">
          ...
          {Array.from({ length: 8 }).map((_, k) => (
            <div key={k} className="flex shrink-0 gap-12 pr-12">
              {[
                ...
                <span key={t} className="flex shrink-0 items-center gap-3 whitespace-nowrap">
                  ◆ {t}
                </span>
              ))}
            </div>
