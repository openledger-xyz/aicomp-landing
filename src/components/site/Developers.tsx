      ...
      <div className="container-x grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="reveal">
          ...
          <ScrambledText
            ...
            text="Built for shipping, not experimenting."
          />
          <p
            className="mt-8 max-w-lg"
            style={{ color: "var(--ink-soft)", fontSize: 16, lineHeight: 1.6 }}
          >
            Everything you need to go from idea to production — without duct-taping five services
            together.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <button type="button" className="btn btn-primary" onClick={() => setWaitlistOpen(true)}>
              Join Waitlist
              <span className="material-symbols-outlined" style={{ fontSize: 16, marginLeft: 6 }}>
                arrow_forward
              </span>
            </button>
            <a
        ...
        <div
          ref={wrapRef}
          className="reveal"
          style={{ background: "#0a0a0a", border: "1px solid var(--ink)" }}
        >
          <div className="flex gap-1.5 px-4 py-3" style={{ borderBottom: "1px solid #222" }}>
            ...
            <span className="ml-3" style={{ color: "#666", fontSize: 11, fontFamily: "monospace" }}>
              ~/dopamint
            </span>
          </div>
          <pre
